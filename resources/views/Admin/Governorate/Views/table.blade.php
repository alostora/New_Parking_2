<section class="content">
    ...
    <div class="box box-info">
        <div class="box-header">
            ...
            <div class="col-md-4">
                <a href="{{ url('admin/governorate/create?country_id=' . Request('country_id')) }}"
                    ...
                    @if (!empty($governorates))
                        @foreach ($governorates as $key => $governorate)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/governorate/edit/' . $governorate->id) }}"
                                        class="btn btn-info btn-sm">
                                        <i class="fa fa-edit"></i>
                                    </a>

                                    @if ($governorate->stopped_at == null)
                                        <a href="{{ url('admin/governorate-inactive/' . $governorate->id) }}"
                                            class="btn btn-success btn-sm">
                                            <i class="fa fa-check"></i> @lang('general.active')
                                        </a>
                                    @else
                                        <a href="{{ url('admin/governorate-active/' . $governorate->id) }}"
