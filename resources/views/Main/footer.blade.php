...
<!-- datepicker -->
<script src="{{ url('AdminDesign') }}/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js">
</script>
<!-- Bootstrap WYSIHTML5 -->
        ...
        if (document.getElementById("example2_wrapper") != null) {
            ...
            children[0].childNodes[0].innerHTML +=
                ...
                `
                    ...
                    <div class="col-md-3">
                        <select class="form-control" onchange='requestActive(this.value)'>
