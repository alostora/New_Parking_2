...
class FinalClient extends Model
{
    ...
    public function getFinalClientQrAttribute()
    {
        ...
        $systemNo = "0007901"; // [ Length => 7, Data => CODESITE+NODE ZONE, Comment =>To be provided by Orbility ]
        ...
        $validUntil = Carbon::now()->addDays(1)->format('YmdHis'); // [ Length => 14, Data => 20130910235959, Comment =>Date/Hour on format YYYYMMDDHHMMSS To be generated by the App ]
        ...
        return QrCode::size(200)->generate($compelete_code);
    }
