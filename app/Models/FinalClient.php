...
class FinalClient extends Model
{
    ...
    public function getFinalClientQrAttribute()
    {
        ...
        $validUntil = Carbon::now()->addHours(12)->format('YmdHis'); // [ Length => 14, Data => 20130910235959, Comment =>Date/Hour on format YYYYMMDDHHMMSS To be generated by the App ]
        // $validUntil = /* "20250320122000" */ Carbon::now()->addHours($this->client->voucher_valid_hours)->format('YmdHis'); // [ Length => 14, Data => 20130910235959, Comment =>Date/Hour on format YYYYMMDDHHMMSS To be generated by the App ]
